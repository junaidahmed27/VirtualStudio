...
OPENAI_LAYOUT_QA_SOFT_FAIL_ON_INVALID_JSON=true
...
- Generated photos are checked against the original before being saved; images that change fixed layout, windows, doors, counters, appliances, closets, or other permanent features are rejected and retried. If the QA checker itself times out, the generated image is kept visible for review instead of being discarded.
